...
const DATA_DOMAIN = assertEnv(process.env.NEXT_PUBLIC_DATA_DOMAIN, "DATA_DOMAIN");
...
export const Config = {
  ...
  adminSecret: assertEnv(process.env.NEXT_PUBLIC_HASURA_GRAPHQL_ADMIN_SECRET, "HASURA_GRAPHQL_ADMIN_SECRET"),
  authSessionKey: assertEnv(process.env.NEXT_PUBLIC_AUTH_SESSION_KEY, "AUTH_SESSION_KEY"),
